      ...
      <div className="relative z-30 text-center max-w-6xl mx-auto px-4 sm:px-6 pointer-events-none pt-16 sm:pt-4">
        <div className="animate-fade-in">
          ...
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 mb-6 sm:mb-8 max-w-4xl mx-auto leading-relaxed px-2">
            Your direct line to Spain's top manufacturers. 
            Wholesale PWD protein specialists, Protella innovations & Elevenfit flavors.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mt-8 sm:mt-16 px-2 pb-8 md:pb-0">
            <div className="text-center animate-slide-up">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-white mb-2">Premium Products</h3>
              <p className="text-sm sm:text-base text-gray-300">Curated selection from Europe's leading nutrition brands</p>
            </div>
            ...
            <div className="text-center animate-slide-up [animation-delay:200ms]">
              ...
              <p className="text-sm sm:text-base text-gray-300">Seamless import process from Europe to US markets</p>
            </div>
            ...
            <div className="text-center animate-slide-up [animation-delay:400ms]">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-white mb-2">Growth Partner</h3>
              <p className="text-sm sm:text-base text-gray-300">Supporting distributors with exclusive brand access</p>
            </div>
          </div>
        </div>
      </div>
